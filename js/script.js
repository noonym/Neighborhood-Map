...
function initMap() {
  ...
  center: {lat: 24.816406, lng: 46.726953},
  zoom: 17,
  ...
  var locations = [
    {title: 'Imam University', location: {lat: 24.814466, lng: 46.705985}},
    {title: 'Jarir Bookstore', location: {lat: 24.818152, lng: 46.686882}},
    {title: 'Dar Al Uloom University', location: {lat: 24.795928, lng: 46.711258}},
    {title: 'Microsoft Office', location: {lat: 24.805940, lng: 46.716837}},
    {title: 'Astronaut Square', location: {lat: 24.794045, lng: 46.721731}},
    {title: 'Shawarmer', location: {lat: 24.797973, lng: 46.697182}}
  ];
  ...
  var viewModel = {
    ...
    clickedList: function(){
      for (var x = 0; x < viewModel.markers.length; x++){
        populateInfoWindow(viewModel.markers[x], largeInfowindow);
      }
    }
  };
